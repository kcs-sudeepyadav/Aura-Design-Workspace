...
export function useApiData(resource: string) {
  ...
  const fetchData = async () => {
    try {
      ...
      const MOCK_VERSION = '1782220719869'; // Bump to guarantee wipe
      ...
      if (resource === 'conversations') {
        ...
        initialMockData = [
          ...
          { id: 'd-3', name: 'Living Room 3D Layout.glb', type: '3D', date: 'May 14, 2026', size: '3.1 MB', projectId: 'p-1', url: '/models/LivingRoom.glb' },
          { id: 'd-4', name: 'Exterior Lantern 3D Model.glb', type: '3D', date: 'May 13, 2026', size: '1.8 MB', projectId: 'p-1', url: '/models/Lantern.glb' }
        ];
